                        ...
                        {isSignUp && (
                            <div className="space-y-2">
                                <div className="flex items-start gap-2">
                                    ...
                                    />
                                    <label htmlFor="admin-terms" className="text-xs text-slate-400 leading-tight">
                                ...
                                {showTermsError && (
                                    <p className="text-xs text-red-400">You must agree to the terms and privacy policy to sign up.</p>
                                )}
                            </div>
                        )}
