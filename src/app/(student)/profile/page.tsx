        ...
        <div className="container mx-auto max-w-lg px-4 py-8">
            ...
            <div className="mb-8 text-center">
                <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-neutral-100 dark:bg-neutral-800">
                    <User className="h-10 w-10 text-neutral-500 dark:text-neutral-500" />
                </div>
            ...
            <Card className="mb-6">
                ...
                <CardContent className="space-y-3">
                    <div className="flex items-center gap-3">
                        <Mail className="h-4 w-4 text-neutral-500 dark:text-neutral-500" />
            ...
            <Card className="mb-6">
                ...
                <CardContent>
                    <div className="flex items-center justify-between">
                        <span className="text-sm text-neutral-600 dark:text-neutral-400">{t('selectLanguage')}</span>
                        <LanguageSwitcher />
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="mb-6">
                <CardHeader className="flex flex-row items-center justify-between pb-3">
                    ...
                    <Link href="/orders" className="text-sm text-neutral-600 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-200">
                        {tCommon('viewAll')}
                    </Link>
                </CardHeader>
                <CardContent>
                    {recentOrders.length > 0 ? (
                        <div className="space-y-3">
                            {recentOrders.map(order => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <Clock className="h-4 w-4 text-neutral-500 dark:text-neutral-500" />
                                        <div>
                                            <p className="text-sm font-medium text-neutral-900 dark:text-white">{order.id}</p>
                                            <p className="text-xs text-neutral-600 dark:text-neutral-400">{tCommon('items', { count: order.items.length })} • {tCommon('currency', { amount: order.total })}</p>
                                        </div>
                                    </div>
                        ...
                        <p className="text-center text-sm text-neutral-600 dark:text-neutral-400 py-4">
                            {tCommon('noOrders')}
                        </p>
                    )}
                </CardContent>
